      ...
      <div class="header">
        <div class="title">
          <h1>
            ...
            <span v-if="setting.previewFeature" v-clean-tooltip="'Preview feature is experimental or early-access functionality allow user to test and evaluate new capabilities before officially released'" class="preview-feature">
              Preview Feature
            </span>
          </h1>
